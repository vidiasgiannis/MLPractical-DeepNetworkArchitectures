...
#Adding code for applying Batch Normalization
...
#Adding code for applying Batch Normalization and Residual Connections
elif args.block_type == 'bn_rc_conv_block':
    processing_block_type = RC_BN_ConvolutionalProcessingBlock
    dim_reduction_block_type = BN_ConvolutionalDimensionalityReductionBlock
